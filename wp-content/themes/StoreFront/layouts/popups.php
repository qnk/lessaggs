...
<div id="gk-popup-login" class="gk-popup">	
	<div class="gk-popup-wrap">
		...
		<?php else : ?>
		    <h3><small><?php _e('Log In', GKTPLNAME); ?></small></h3>
		    <small><a href="<?php echo home_url(); ?>/wp-login.php?action=register" title="<?php _e('Not a member? Register', GKTPLNAME); ?>"><?php _e('create an account', GKTPLNAME); ?></a></small>
